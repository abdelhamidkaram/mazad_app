                        ...
                        Padding(
                          ...
                          child: AppButtons.appButtonBlue(() {
                            RegisterRequest registerRequest = RegisterRequest(
                              ...
                              name:emailController.text.contains("@")? emailController.text.substring(0,emailController.text.indexOf("@")) : emailController.text.toString(),
                              phone: phoneController.text,
                              surName: emailController.text.contains("@")? emailController.text.substring(0,emailController.text.indexOf("@")) : emailController.text.toString(),
                              userName: emailController.text.contains("@")? emailController.text.substring(0,emailController.text.indexOf("@")) : emailController.text.toString(),
                            );
